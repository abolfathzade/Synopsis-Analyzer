...
class NamedTensor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NamedTensor) */ {
 public:
  NamedTensor();
  virtual ~NamedTensor();
  ...
  static const NamedTensor* internal_default_instance();

  void UnsafeArenaSwap(NamedTensor* other);
  ...
  void UnsafeMergeFrom(const NamedTensor& from);
  protected:
  explicit NamedTensor(::google::protobuf::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::google::protobuf::Arena* arena);
  private:
  ...
  private:
  void _slow_mutable_val();
  void _slow_set_allocated_val(
      ::google::protobuf::Arena* message_arena, ::tensorflow::TensorProto** val);
  ::tensorflow::TensorProto* _slow_release_val();
  public:
  ...
  ::tensorflow::TensorProto* unsafe_arena_release_val();
  void unsafe_arena_set_allocated_val(
      ::tensorflow::TensorProto* val);
...
extern ::google::protobuf::internal::ExplicitlyConstructed<NamedTensor> NamedTensor_default_instance_;
...
inline ::std::string* NamedTensor::unsafe_arena_release_key() {
  // @@protoc_insertion_point(field_unsafe_arena_release:tensorflow.NamedTensor.key)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void NamedTensor::unsafe_arena_set_allocated_key(
    ::std::string* key) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  if (key != NULL) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:tensorflow.NamedTensor.key)
}
...
inline  void NamedTensor::set_allocated_val(::tensorflow::TensorProto* val) {
  ...
  if (val != NULL) {
    _slow_set_allocated_val(message_arena, &val);
  }
  val_ = val;
  if (val) {
...
inline const NamedTensor* NamedTensor::internal_default_instance() {
  return &NamedTensor_default_instance_.get();
}
// -------------------------------------------------------------------
