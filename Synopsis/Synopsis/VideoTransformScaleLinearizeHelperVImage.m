//
//  VideoTransformScaleLinearizeHelperVImage.m
//  Synopsis Analyzer
//
...
@interface VideoTransformScaleLinearizeHelperVImage ()
{
...
@implementation VideoTransformScaleLinearizeHelperVImage
                  ...
                  completionBlock:(VideoTransformScaleLinearizeCompletionBlock)completionBlock
{
    ...
    //
    //    [self.queue addOperation:transformBlock];
}
